...
## Overview of Project
This project is done to focus on the work that needs to be done to convince investors that a bike-sharing program in Des Moines is a solid business proposal. To solidify the proposal, one of the key stakeholders would like to see a bike trip analysis.

For this analysis, I'll use Pandas to change the "tripduration" column from an integer to a datetime datatype. Then, I'll using the converted datatype, I’ll create a set of visualizations to:
...
1. ***Part I***: Change Trip Duration to a Datetime Format
2. ***Part II***: Create Visualizations for the Trip Analysis
3. ***Part III***: Create a Story and Report for the Final Presentation
...
# 4. Check the datatypes of columns. 
citibike_df.info()
````
...
In this visualization, I'll graph the length of time that bikes are checked out for all riders.
...
In this visualization, I’ll graph the number of bike trips by gender for each hour of each day of the week as a heatmap.
...
In this visualization, I’ll graph the number of bike trips by gender for each hour for each day of the week as a heatmap.
...
##### Bike Sharing Project Analysis Completed by Morifing Koné
